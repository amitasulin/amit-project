export const p1 = `Cannabis, also known as marijuana among other names, is a
...
export const p2 = `Onset of effects is felt within minutes when smoked, but may take
...
export const p3 = `There is a strong relation between cannabis use and the risk of
